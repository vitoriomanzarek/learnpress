<?php
/**
 * Class LP_Modal_Search_Courses_API.
 *
 * @author  ThimPress
...
if ( ! class_exists( 'LP_Modal_Search_Courses_API' ) ) {
	...
	class LP_Modal_Search_Courses_API {
		...
		/**
		 * LP_Modal_Search_Courses_API constructor.
		 *
		...
		/**
		 * @return bool|LP_Modal_Search_Courses_API
		 */
